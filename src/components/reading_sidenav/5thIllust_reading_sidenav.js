  ...
  return (
    <Menu>
        <div className='reading-sidenav-container'>
            ...
            <button className='reading-sidenav-btn' type='button' onClick={()=>navigate('/detail5thIllust')}><img className='reading-sidenav-icon' src={InfoIcon} />Book Details</button>
